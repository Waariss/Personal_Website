    ...
    return (
        <section id="home" className="text-center my-4 home-section">
            <Container className="jumbotron-style">
                ...
                <p className="lead">Offensive Security Engineer | C-APIPen | CRTP | BSCP | PMPA | CCPenX-AWS | CMPen-IOS | C-AI/MLPen | CRTA | CRT-ID | MCRTA | GHF | CBBH | CMPen-Android | CAPenX | CNPen | CAPen | CAP</p>
                <hr className="my-4" />
