    ...
    return (
        <section id="home" className="text-center my-4 home-section">
            <Container className="jumbotron-style">
                ...
                <p className="lead">Offensive Security Engineer | PNPT | PMPA | eWPTX | CRTP | CPTS | CBBH | BSCP | ASCP | ACP | GHF | CDL | HCCDA-Tech | C-APIPen | C-AI/MLPen | CCPenX-AWS | CAPenX | CMPen-Android & iOS | CNPen | CAPen | CAP | CRTA | CRT-ID | MCRTA</p>
                <hr className="my-4" />
