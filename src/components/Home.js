    ...
    return (
        <section id="home" className="text-center my-4 home-section">
            <Container className="jumbotron-style">
                ...
                <p className="lead">Offensive Security Engineer | eWPTX | PNPT | PMPA | CPTS | CBBH | BSCP | CRTP | GHF | C-APIPen | CCPenX-AWS | C-AI/MLPen | CMPen-Android & iOS | CAPenX | CNPen | CAPen | CAP | CRTA | CRT-ID | MCRTA</p>
                <hr className="my-4" />
