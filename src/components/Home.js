        ...
        <section id="home" className="text-center my-4 home-section">
            <Container className="jumbotron-style">
                ...
                <Stack direction="horizontal" gap={2} className="justify-content-center flex-wrap my-3">
                    {['OSCP+', 'OSCP', 'PNPT', 'PMPA', 'PSAA', 'eWPTX', 'CRTP', 'CPTS', 'CWES', 'CJCA', 'BSCP', 'PT1', 'ASCP', 'ACP', 'GHF', 'CDL', 'HCCDA-Tech', 'CKBPro', 'C-APIPen', 'C-AI/MLPen', 'CCPenX-AWS', 'CAPenX', 'CMPen-Android & iOS', 'CNPen', 'CAPen', 'CAP', 'CRTA', 'CRT-ID', 'MCRTA','CCEP', 'CCPC', 'CVE-2025-12782', 'CVE-2025-14166', 'CVE-2025-14068', 'CVE-2025-14366', 'CVE-2025-14003', 'CVE-2025-13693', 'CVE-2025-14153', 'CVE-2025-14626', 'CVE-2025-14453'].map((credential) => (
