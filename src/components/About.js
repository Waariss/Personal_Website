            ...
            <Card className="border-0 shadow-sm about-card mb-4">
                ...
                <Row>
                    ...
                    <Col xs={12} md={8}>
                        ...
                        <Card.Text>
                            I am a final-year <strong className="strong-highlight">Software Engineer</strong> 🖥️ student at Mahidol University, specializing in Information and Communication Technology (ICT). My academic pursuits are driven by a strong passion for <strong className="strong-highlight">Linux</strong> 🐧, <strong className="strong-highlight">Cybersecurity</strong> 🔒, <strong className="strong-highlight">Artificial Intelligence</strong> 🤖, and <strong className="strong-highlight">DevOps</strong> ⚙️. I have spearheaded significant projects, including an investigation into OAuth 2.0 vulnerabilities and the development of an AI-based framework to combat COVID-19, both of which have been presented at conferences and featured in publications. Additionally, I completed a Penetration Tester internship at KPMG Thailand 🇹🇭, which has significantly enhanced my practical cybersecurity skills. Eager to apply my diverse ICT skills in a dynamic professional setting, I am actively seeking full-time opportunities where I can continue to grow, gain valuable industry insights, and contribute innovatively to a collaborative work environment.
                        </Card.Text>
