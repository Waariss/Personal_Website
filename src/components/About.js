            ...
            <Card className="border-0 shadow-sm about-card mb-4">
                ...
                <Row>
                    ...
                    <Col xs={12} md={8}>
                        ...
                        <Card.Text>
                            I am a final-year <strong className="strong-highlight">Software Engineering</strong> 🖥️ student at Mahidol University with a keen interest in <strong className="strong-highlight">Cybersecurity</strong> 🔒, <strong className="strong-highlight">Artificial Intelligence</strong> 🤖, and <strong className="strong-highlight">DevOps</strong> ⚙️, as part of my Information and Communication Technology (ICT) major. My experience includes leading significant projects that explored OAuth 2.0 vulnerabilities and developing an AI-based framework for COVID-19, which have led to presentations at conferences and published research. These academic pursuits have deepened my passion for utilizing technology to tackle complex challenges. As I actively seek internship or full-time opportunities, I am enthusiastic about applying my diverse ICT skills in practical settings and contributing to an innovative team. Committed to continuous professional growth, I aim to further enhance my skills, acquire valuable industry insights, and bring a dedicated spirit of innovation to a collaborative work environment.
                        </Card.Text>
